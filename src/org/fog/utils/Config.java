...
public class Config {
	...
	public static int MAX_SIMULATION_TIME = 3000;
	public static final double CRITICALITY_FLIP_INTERVAL = MAX_SIMULATION_TIME/100;
	public static int RESOURCE_MANAGE_INTERVAL = 50;
