...
public class AppModule extends PowerVm{
	...
	//MAT 27/6/2019
		...
		protected int critLevel;
		protected boolean secFlag; // Security flag
		
		
		//MAT 12/10/2019
		
		List<String> essentialSecurityRequirements;
		List<String> nonEssentialSecurityRequirements;
	...
	public AppModule(
		...
		setEssentialSecurityRequirements(new ArrayList<String>());
		setNonEssentialSecurityRequirements(new ArrayList<String>());
	}
	...
	//MAT 12/10/2019
		 public List<String> getEssnetialSecurityRequirements() {
		        return essentialSecurityRequirements;
		    }
		 
		 public void setEssentialSecurityRequirements(List<String> securityRequirements){
		        this.essentialSecurityRequirements = securityRequirements;
		    }
		 
		 
		 public List<String> getNonEssnetialSecurityRequirements() {
		        return nonEssentialSecurityRequirements;
		    }
		 
		 public void setNonEssentialSecurityRequirements(List<String> securityRequirements){
		        this.nonEssentialSecurityRequirements = securityRequirements;
		    }
		 
		 
		 public void setCriticalityLevel(int crit)
		 {
			 this.critLevel = crit;
		 }
		 
		 public int getCrticalityLevel()
		 {
