...
public class MyApplication {
	...
	public static MyApplication createApplication(String appId, int userId, double secWt, double critWt){
		return new MyApplication(appId, userId,secWt, critWt);
	}
	...
	public MyApplication(String appId, int userId, double secWt, double critWt) {
		setAppId(appId);
		setUserId(userId);
		setModules(new ArrayList<AppModule>());
		setEdges(new ArrayList<AppEdge>());
		...
		setLoops(new ArrayList<AppLoop>());
		setEdgeMap(new HashMap<String, AppEdge>());
		this.setSecWeight(secWt);
		this.setCritWeight(critWt);
	}
		...
		for(AppEdge edge : getEdges()){
			if(edge.getSource().equals(moduleName)){
				...
				if(selectivityModel.canSelect()){
					...
					//	tuple.setOriginalSrcDeviceId(sourceDeviceId);
	...
	private Map<Integer, Map<String, Double>> sensingInfo;
	private Map<Integer, Map<String, Double>> inputDataInfo;
	private Map<Integer, Map<String, Integer>> inputPrivacyInfo;
	private Map<Integer, Map<String, Integer>> inputPrivacyCountInfo;
	
	
	private Map<Integer, Map<String, Integer>> additionalMipsInfo;
	private Map<Integer,Map<String,List<String>>> moduleEssSecReqInfo;
	private Map<Integer,Map<String,List<String>>> moduleNonEssSecReqInfo;
	...
	public void setSensingInfo(Map<Integer, Map<String, Double>> Info) {
		this.sensingInfo = Info;
	}
	
	public Map<Integer, Map<String, Double>> getSensingInfo() {
		return sensingInfo;
	}
	
	public void setInputDataInfo(Map<Integer, Map<String, Double>> Info) {
		this.inputDataInfo = Info;
	}
	
	public Map<Integer, Map<String, Double>> getInputDataInfo() {
		return inputDataInfo;
	}
	
	
	public void setInputPrivacyInfo(Map<Integer, Map<String, Integer>> Info) {
		this.inputPrivacyInfo = Info;
	}
	
	public Map<Integer, Map<String, Integer>> getInputPrivacyInfo() {
		return inputPrivacyInfo;
	}
	
	
	public void setInputPrivacyCountInfo(Map<Integer, Map<String, Integer>> Info) {
		this.inputPrivacyCountInfo = Info;
	}
	
	public Map<Integer, Map<String, Integer>> getInputPrivacyCountInfo() {
		return inputPrivacyCountInfo;
	}
	...
	public void setModuleEssSecReqInfo (Map<Integer,Map<String,List<String>>> moduleEssSecReqInfo)
	{
		this.moduleEssSecReqInfo = moduleEssSecReqInfo;
	}
	
	public Map<Integer,Map<String,List<String>>> getModuleEssSecReqInfo()
	{
		return this.moduleEssSecReqInfo;
	}
	
	public void setModuleNonEssSecReqInfo (Map<Integer,Map<String,List<String>>> moduleNonEssSecReqInfo)
	{
		this.moduleNonEssSecReqInfo = moduleNonEssSecReqInfo;
	}
	
	public Map<Integer,Map<String,List<String>>> getModuleNonEssSecReqInfo()
	{
		return this.moduleNonEssSecReqInfo;
	}
	...
	public void setCritWeight(double wt)
	{
		critWeight = wt;
	}
	
	public void setSecWeight(double wt)
	{
		secWeight = wt;
	}
