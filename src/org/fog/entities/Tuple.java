...
public class Tuple extends Cloudlet{
	...
	private int originalSrcDeviceId;
	...
	public void setOriginalSrcDeviceId(int num)
	{
		this.originalSrcDeviceId = num;
	}

	public int getOriginalSrcDeviceId()
	{
		return this.originalSrcDeviceId;
	}
	
	public void setActualSrcId(String name)
	{
		this.actualSrcId = name;
	}
	
	public String getActualSrcId()
	{
		return this.actualSrcId;
	}
}
