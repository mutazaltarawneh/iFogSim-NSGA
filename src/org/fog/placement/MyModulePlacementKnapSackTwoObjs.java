...
public class MyModulePlacementKnapSackTwoObjs extends MyPlacement{
	...
	public MyModulePlacementKnapSackTwoObjs(List<MyFogDevice> fogDevices, List<MySensor> sensors, List<MyActuator> actuators, 
